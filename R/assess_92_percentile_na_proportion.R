#' Feature Extraction: 92nd percentile of the proportion of NA values present in the middle of a 3d scan,
...
#' the proportion of missing values in each of those rows. We then take the 92nd percentile proportion of missing values
...
#' @examples
#' data(fau277_bb_l2)
#' assess_92_percentile_na_proportion(fau277_bb_l2)
assess_92_percentile_na_proportion<- function(x3p, chopoff = 1/6, numlines = 200) {
  ...
  percentile <- quantile(ProportionNA, probs = 0.92)
